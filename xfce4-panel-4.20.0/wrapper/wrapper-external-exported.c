...
enum
{
  WRAPPER_EXTERNAL__EXPORTED_SET_REQUISITION,
  WRAPPER_EXTERNAL__EXPORTED_EMBEDDED,
  WRAPPER_EXTERNAL__EXPORTED_POINTER_ENTER,
  WRAPPER_EXTERNAL__EXPORTED_POINTER_LEAVE,
};

static unsigned WRAPPER_EXTERNAL__EXPORTED_SIGNALS[4] = { 0 };
...
inline static void
wrapper_external_exported_signal_marshal_set_requisition (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
wrapper_external_exported_signal_marshal_embedded (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
wrapper_external_exported_signal_marshal_pointer_enter (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
wrapper_external_exported_signal_marshal_pointer_leave (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
inline static void
wrapper_external_exported_method_marshal_pointer_is_outside (
    GClosure     *closure,
    GValue       *return_value,
    unsigned int  n_param_values,
    const GValue *param_values,
...
wrapper_external_exported_default_init (WrapperExternalExportedIface *iface)
{
   ...
   */
  WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_SET_REQUISITION] =
   ...
   * On the service-side, this signal can be used with e.g. g_signal_emit_by_name() to make the object emit the D-Bus signal.
   */
  WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_EMBEDDED] =
   ...
   * On the service-side, this signal can be used with e.g. g_signal_emit_by_name() to make the object emit the D-Bus signal.
   */
  WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_POINTER_ENTER] =
   ...
   * On the service-side, this signal can be used with e.g. g_signal_emit_by_name() to make the object emit the D-Bus signal.
   */
  WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_POINTER_LEAVE] =
...
{
  g_signal_emit (object, WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_SET_REQUISITION], 0, arg_requisition);
}
...
wrapper_external_exported_emit_embedded (
    WrapperExternalExported *object)
{
  g_signal_emit (object, WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_EMBEDDED], 0);
}
...
wrapper_external_exported_emit_pointer_enter (
    WrapperExternalExported *object)
{
  g_signal_emit (object, WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_POINTER_ENTER], 0);
}
...
wrapper_external_exported_emit_pointer_leave (
    WrapperExternalExported *object)
{
  g_signal_emit (object, WRAPPER_EXTERNAL__EXPORTED_SIGNALS[WRAPPER_EXTERNAL__EXPORTED_POINTER_LEAVE], 0);
}
