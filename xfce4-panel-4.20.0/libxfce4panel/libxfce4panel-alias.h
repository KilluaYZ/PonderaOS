...
extern __typeof (xfce_panel_plugin_popup_window) IA__xfce_panel_plugin_popup_window __attribute((visibility("hidden")));
...
extern __typeof (xfce_panel_plugin_provider_get_type) IA__xfce_panel_plugin_provider_get_type __attribute((visibility("hidden")));
