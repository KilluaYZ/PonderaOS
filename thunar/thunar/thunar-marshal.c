...
/* VOID:UINT64,UINT64,UINT,UINT,UINT (thunar-marshal.list:8) */
void
_thunar_marshal_VOID__UINT64_UINT64_UINT_UINT_UINT (GClosure     *closure,
                                                    GValue       *return_value G_GNUC_UNUSED,
                                                    guint         n_param_values,
                                                    const GValue *param_values,
                                                    gpointer      invocation_hint G_GNUC_UNUSED,
                                                    gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__UINT64_UINT64_UINT_UINT_UINT) (gpointer data1,
                                                                   guint64 arg1,
                                                                   guint64 arg2,
                                                                   guint arg3,
                                                                   guint arg4,
  ...
  GCClosure *cc = (GCClosure *) closure;
  gpointer data1, data2;
  GMarshalFunc_VOID__UINT64_UINT64_UINT_UINT_UINT callback;
  ...
  callback = (GMarshalFunc_VOID__UINT64_UINT64_UINT_UINT_UINT) (marshal_data ? marshal_data : cc->callback);
