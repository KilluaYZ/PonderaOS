...
void xfsm_manager_complete_inhibit (
    XfsmManager *object,
    GDBusMethodInvocation *invocation,
    guint inhibit_cookie);

void xfsm_manager_complete_uninhibit (
    XfsmManager *object,
    GDBusMethodInvocation *invocation);

void xfsm_manager_complete_is_inhibited (
    XfsmManager *object,
    GDBusMethodInvocation *invocation,
    gboolean is_inhibited);

void xfsm_manager_complete_lock (
    XfsmManager *object,
    GDBusMethodInvocation *invocation,
    gboolean locked);
...
void xfsm_manager_call_inhibit (
    XfsmManager *proxy,
    const gchar *arg_app_id,
    guint arg_toplevel_xid,
    const gchar *arg_reason,
...
gboolean xfsm_manager_call_inhibit_sync (
    XfsmManager *proxy,
    const gchar *arg_app_id,
    guint arg_toplevel_xid,
    const gchar *arg_reason,
...
void xfsm_manager_call_uninhibit (
    XfsmManager *proxy,
    guint arg_inhibit_cookie,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean xfsm_manager_call_uninhibit_finish (
    XfsmManager *proxy,
    GAsyncResult *res,
    GError **error);

gboolean xfsm_manager_call_uninhibit_sync (
    XfsmManager *proxy,
    guint arg_inhibit_cookie,
    GCancellable *cancellable,
    GError **error);

void xfsm_manager_call_is_inhibited (
    XfsmManager *proxy,
    guint arg_flags,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
